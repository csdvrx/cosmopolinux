...
# Cosmopolinux compilation script, with fixes for bintfmt
...
[ -d ${COSMOCC}/bin ] \
 || exit 1
# TODO: could wget and unzip that to /opt under sudo, but only if the user accepts
...
# Also consider submitting to https://github.com/ahgamut/superconfigure

 [ -x ./configure ] \
 && ./configure --prefix=${COSMOS} \
 || echo "No ./configure"
# TODO: should check for autoconf etc
